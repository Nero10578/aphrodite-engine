...
from aphrodite.lora.layers.utils import _get_lora_device, try_get_optimal_moe_lora_config
...
class FusedMoEWithLoRA(BaseLayerWithLoRA):
    ...
    def _get_lora_moe_configs(
        ...
        if envs.APHRODITE_TUNED_CONFIG_FOLDER:
            ...
            shrink_config = try_get_optimal_moe_lora_config(
                op_type=f"fused_moe_lora_{op_prefix}_shrink",
    ...
    def _inject_lora_into_fused_moe(self):
        ...
        self.base_layer.quant_method.old_fused_experts = self.base_layer.quant_method.fused_experts
